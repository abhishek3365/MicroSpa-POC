...
var routes = [
    ...
    { path: 'main', component: _main_main_component__WEBPACK_IMPORTED_MODULE_3__["MainComponent"], canActivate: [_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]], children: [
            { path: '', component: _items_items_component__WEBPACK_IMPORTED_MODULE_5__["ItemsComponent"] },
            { path: 'item-list', component: _items_items_component__WEBPACK_IMPORTED_MODULE_5__["ItemsComponent"] },
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(store, loginService) {
        this.store = store;
        this.loginService = loginService;
    }
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["Store"], _services_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"]])
    ], HeaderComponent);
...
/***/ "./src/app/items/item-details/item-details.component.css":
/*!***************************************************************!*\
  !*** ./src/app/items/item-details/item-details.component.css ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/items/item-details/item-details.component.html":
/*!****************************************************************!*\
  !*** ./src/app/items/item-details/item-details.component.html ***!
  \****************************************************************/
/*! no static exports found */
...
var ItemDetailsComponent = /** @class */ (function () {
    ...
    ItemDetailsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./item-details.component.html */ "./src/app/items/item-details/item-details.component.html"),
            styles: [__webpack_require__(/*! ./item-details.component.css */ "./src/app/items/item-details/item-details.component.css")]
        }),
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-xs-10\">\r\n    <ul class=\"list-group\">\r\n      <a\r\n        class=\"list-group-item\"\r\n        style=\"cursor: pointer\"\r\n        *ngFor=\"let item of (itemListState | async).items; let i = index\"\r\n      >\r\n        <button class=\"btn btn-primary\" type=\"button\" (click)=\"onAddItem(item)\">Add to cart</button>\r\n        {{ item.title }}\r\n      </a>\r\n    </ul>\r\n  </div>\r\n</div>"
...
/* harmony import */ var _store_actions_shopping_list_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store/actions/shopping-list.actions */ "./src/app/store/actions/shopping-list.actions.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ItemListComponent = /** @class */ (function () {
    function ItemListComponent(itemService, store) {
    ...
    ItemListComponent.prototype.onAddItem = function (item) {
        this.store.dispatch(new _store_actions_shopping_list_actions__WEBPACK_IMPORTED_MODULE_3__["AddItem"](item));
    };
    ItemListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_items_service__WEBPACK_IMPORTED_MODULE_1__["ItemsService"], _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"]])
    ], ItemListComponent);
...
module.exports = "<div style=\"text-align:center\">\r\n  <!-- <img class=\"c1\" src=\"assets/digilab.png\" alt=\"DigiLab\"> -->\r\n  <form (ngSubmit)=\"onSubmit()\" #f=\"ngForm\"> \r\n    <!-- removed f from onSubmit(f) for viewChild -->\r\n    <input \r\n      type=\"email\" \r\n      placeholder=\"Email\"\r\n      ngModel\r\n      name=\"email\"\r\n      required><br><br>\r\n    <input \r\n      type=\"password\" \r\n      placeholder=\"Password\"\r\n      ngModel\r\n      name=\"password\"\r\n      required><br><br><br>\r\n    <button \r\n      color=\"primary\"\r\n      mat-raised-button\r\n      type=\"submit\" \r\n      name=\"login\"\r\n      [disabled]=\"!f.valid && !showSpinner\">LOGIN</button>\r\n  </form>\r\n  <mat-spinner *ngIf=\"showSpinner\" [diameter]=\"40\" class=\"spinner\"></mat-spinner>\r\n</div>"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.loginService
            ...
            _this.showSpinner = false;
            _this.snackBar.open(message, 'Dismiss', {
                duration: 2500,
            });
        });
    };
...
var ItemsService = /** @class */ (function () {
    ...
    ItemsService.prototype.setItems = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.httpClient
                .get(_utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].BASE_URL + "vegetables", { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('token', _this.cookieService.get('token')) })
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.storeUserDetails = function (userDetails) {
        this.email = userDetails.email;
    };
    LoginService.prototype.validateCredentials = function (email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var requestJson = { "email": email,
                "password": password };
            _this.http.post(_utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].BASE_URL + 'login', requestJson)
                .subscribe(function (responseJson) {
                var success = responseJson.success;
                if (success) {
                    _this.userType = responseJson.payload.user_type;
                    _this.email = responseJson.payload.email;
                    _this.name = responseJson.payload.name;
                    _this.token = responseJson.payload.token;
    ...
    LoginService.prototype.signIn = function (token) {
        this.store.dispatch(new _store_actions_auth_actions__WEBPACK_IMPORTED_MODULE_5__["Signin"]());
        this.store.dispatch(new _store_actions_auth_actions__WEBPACK_IMPORTED_MODULE_5__["SetToken"](token));
    };
...
/*!***************************************************!*\
  !*** ./src/app/services/shopping-list.service.ts ***!
  \***************************************************/
/*! exports provided: ShoppingListSerivce */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShoppingListSerivce", function() { return ShoppingListSerivce; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/constants */ "./src/app/utils/constants.ts");
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm5/store.js");
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col-xs-10\">\r\n    <ul class=\"list-group\">\r\n      <a\r\n        class=\"list-group-item\"\r\n        style=\"cursor: pointer\"\r\n        *ngFor=\"let item of (shoppingListState | async).items; let i = index\"\r\n      >\r\n        {{ item.title }}\r\n      </a>\r\n    </ul>\r\n  </div>\r\n</div>\r\n"
...
/*!***********************************************!*\
  !*** ./src/app/store/actions/auth.actions.ts ***!
  \***********************************************/
/*! exports provided: TRY_SIGNIN, SIGNIN, LOGOUT, SET_TOKEN, TrySignin, Signin, Logout, SetToken */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!************************************************!*\
  !*** ./src/app/store/actions/items.actions.ts ***!
  \************************************************/
/*! exports provided: SET_ITEMS, SetItems */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/app/store/actions/shopping-list.actions.ts":
/*!********************************************************!*\
  !*** ./src/app/store/actions/shopping-list.actions.ts ***!
  \********************************************************/
/*! exports provided: SET_CART_ITEMS, ADD_ITEM, DELETE_ITEM, SetItems, AddItem, DeleteItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SET_CART_ITEMS", function() { return SET_CART_ITEMS; });
...
var SET_CART_ITEMS = 'SET_CART_ITEMS';
var ADD_ITEM = 'ADD_ITEM';
var DELETE_ITEM = 'DELETE_ITEM';
var SetItems = /** @class */ (function () {
    function SetItems(payload) {
        this.payload = payload;
        this.type = SET_CART_ITEMS;
    }
    return SetItems;
}());
...
/* harmony import */ var _reducers_auth_reducers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./reducers/auth.reducers */ "./src/app/store/reducers/auth.reducers.ts");
/* harmony import */ var _reducers_item_reducers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reducers/item.reducers */ "./src/app/store/reducers/item.reducers.ts");
/* harmony import */ var _reducers_shopping_list_reducers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reducers/shopping-list.reducers */ "./src/app/store/reducers/shopping-list.reducers.ts");



var reducers = {
    auth: _reducers_auth_reducers__WEBPACK_IMPORTED_MODULE_0__["authReducer"],
    itemList: _reducers_item_reducers__WEBPACK_IMPORTED_MODULE_1__["itemsReducer"],
    shoppingList: _reducers_shopping_list_reducers__WEBPACK_IMPORTED_MODULE_2__["shoppingListReducer"]
};
...
function authReducer(state, action) {
    ...
    switch (action.type) {
        case (_actions_auth_actions__WEBPACK_IMPORTED_MODULE_0__["SIGNIN"]):
        ...
        case (_actions_auth_actions__WEBPACK_IMPORTED_MODULE_0__["SET_TOKEN"]):
...
/***/ "./src/app/store/reducers/item.reducers.ts":
/*!*************************************************!*\
  !*** ./src/app/store/reducers/item.reducers.ts ***!
  \*************************************************/
...
function itemsReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case _actions_items_actions__WEBPACK_IMPORTED_MODULE_0__["SET_ITEMS"]:
...
/***/ "./src/app/store/reducers/shopping-list.reducers.ts":
/*!**********************************************************!*\
  !*** ./src/app/store/reducers/shopping-list.reducers.ts ***!
  \**********************************************************/
...
/* harmony import */ var _actions_shopping_list_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/shopping-list.actions */ "./src/app/store/actions/shopping-list.actions.ts");
var __assign = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
...
function shoppingListReducer(state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case _actions_shopping_list_actions__WEBPACK_IMPORTED_MODULE_0__["SET_CART_ITEMS"]:
            return __assign({}, state, { items: action.payload });
        case _actions_shopping_list_actions__WEBPACK_IMPORTED_MODULE_0__["ADD_ITEM"]:
            return __assign({}, state, { items: state.items.concat([action.payload]) });
        case _actions_shopping_list_actions__WEBPACK_IMPORTED_MODULE_0__["DELETE_ITEM"]:
            var oldItems = state.items.slice();
            var index = oldItems.indexOf(action.payload);
            oldItems.splice(index, 1);
            return __assign({}, state, { items: oldItems });
        default:
            return state;
    }
}
...
module.exports = __webpack_require__(/*! d:\MicroSpa-POC\MicroSpas\Fruits-App\src\main.ts */"./src/main.ts");
