...
var ItemsService = /** @class */ (function () {
    ...
    ItemsService.prototype.setItems = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.httpClient
                .get(_utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].BASE_URL + "dairy", { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('token', _this.cookieService.get('token')) })
